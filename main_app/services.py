...
def get_temptimezone(city):
    geocoding = requests.post(
        f"https://maps.googleapis.com/maps/api/geocode/json?address={city}&key=AIzaSyC6L-lKIsvE0uRCMwLJKrITheGumyORIME")
    ...
    allWeatherDataJson = requests.post(
        f"https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid=b70e5243385456b84556f52c7008f578")
